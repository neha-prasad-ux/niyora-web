---
title: "Your ovaries have a nervous system"
description: "A 2025 study mapped sympathetic nerves running through the ovary, and they thicken with age. Here is what that does and does not tell us about stress."
date: 2026-05-31
collection: research
tags: ["womens-health", "stress", "ovarian-aging", "research"]
draft: true
ogImage: ""
canonical: ""
social:
  linkedin: >
    A study in Science this year did something simple and radical.

    Instead of slicing an ovary onto a microscope slide, the team at UCSF made
    whole, intact ovaries optically clear and imaged them in 3D. Human and mouse.

    What they saw changes the picture. The ovary is wired. Dense sympathetic
    nerve fibers, the same fight-or-flight nerves that fire when you are under
    pressure, run straight through the tissue. And they get denser with age.

    When the researchers removed those nerves in mice, the animals kept more eggs
    in reserve but matured fewer. The nervous system was helping decide when eggs
    start to grow.

    I trained as a doctor before I became a designer. The careful version of this
    finding matters more than the headline. This study does not prove that stress
    ages your ovaries, or that breathing reverses it. It shows the wiring is
    there, and that ovarian aging is active, not just a fixed supply running down.

    I build a small app called Niyora that helps people downregulate that stress
    response in 60 seconds. I am not going to tell you it protects your fertility.
    I will tell you the wiring between your stress response and your reproductive
    system is more literal than most of us were taught. That is worth sitting with.
  x: >
    A 2025 Science study made whole ovaries optically clear and imaged them in 3D.

    They found dense sympathetic nerves, the fight-or-flight kind, running through
    the tissue. Denser with age. Remove them in mice and egg maturation changes.

    The ovary is wired. A thread on what that means, and what it does not.
---
...
- UCSF, "Why does female fertility decline so fast? The key is the ovary," on the Science paper, Oct 2025. https://www.ucsf.edu/news/2025/10/430841/why-does-female-fertility-decline-so-fast-key-ovary
- "Impact of psychological stress on ovarian function," review, International Journal of Molecular Medicine, Dec 2024. https://pmc.ncbi.nlm.nih.gov/articles/PMC11670866/
- "HPA axis activity across the menstrual cycle," systematic review and meta-analysis. https://www.sciencedirect.com/science/article/abs/pii/S0091302222000218
